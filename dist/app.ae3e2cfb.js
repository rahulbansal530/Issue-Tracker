...
var mock_json_1 = __importDefault(require("../mock.json")); // fetch value from HTML's id and store in container
...
var fetchData = function fetchData(todo, inprogress, done, con1, con2, con3) {
  for (var i = 0; i < todo; i++) {
    var user = {
      id: mock_json_1.default.todo[i].id,
      date: mock_json_1.default.todo[i].date,
      heading: mock_json_1.default.todo[i].heading,
      description: mock_json_1.default.todo[i].description,
      designation: mock_json_1.default.todo[i].designation,
      name: mock_json_1.default.todo[i].name,
      profile: mock_json_1.default.todo[i].profile,
      status: mock_json_1.default.todo[i].status
    };
    showUser(user, con1);
  }
  ...
  for (var i = 0; i < inprogress; i++) {
    var user = {
      id: mock_json_1.default.in_progress[i].id,
      date: mock_json_1.default.in_progress[i].date,
      heading: mock_json_1.default.in_progress[i].heading,
      description: mock_json_1.default.in_progress[i].description,
      designation: mock_json_1.default.in_progress[i].designation,
      name: mock_json_1.default.in_progress[i].name,
      profile: mock_json_1.default.in_progress[i].profile,
      status: mock_json_1.default.in_progress[i].status
    };
    showUser(user, con2);
  }
  ...
  for (var i = 0; i < done; i++) {
    var user = {
      id: mock_json_1.default.done[i].id,
      date: mock_json_1.default.done[i].date,
      heading: mock_json_1.default.done[i].heading,
      description: mock_json_1.default.done[i].description,
      designation: mock_json_1.default.done[i].designation,
      name: mock_json_1.default.done[i].name,
      profile: mock_json_1.default.done[i].profile,
      status: mock_json_1.default.done[i].status
    };
    showUser(user, con3);
  }
...
fetchData(mock_json_1.default.todo.length, mock_json_1.default.in_progress.length, mock_json_1.default.done.length, todoCont, inProgressCont, doneCont);
